...
Revision ID: 21314a5a27a5
Revises: 563993c68ee3
Create Date: 2024-06-20 15:36:24.614653
...
revision = '21314a5a27a5'
down_revision = '563993c68ee3'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.add_column('soutenance', sa.Column('slug', sa.String(), nullable=True))
    op.add_column('soutenance', sa.Column('owner_id', sa.Integer(), nullable=True))
    op.create_foreign_key(None, 'soutenance', 'utilisateur', ['owner_id'], ['id'], ondelete='CASCADE')
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint(None, 'soutenance', type_='foreignkey')
    op.drop_column('soutenance', 'owner_id')
    op.drop_column('soutenance', 'slug')
